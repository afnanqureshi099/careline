...
class UserSettings(db.Model):
    ...
    reminder_sound = db.Column(db.String(20), default="On")
    vibration = db.Column(db.Boolean, default=True)
    notification_timing_minutes = db.Column(db.Integer, default=10)
    push_notifications = db.Column(db.Boolean, default=True)
    email_notifications = db.Column(db.Boolean, default=True)
    default_reminder_time = db.Column(db.String(20), default="08:00")
    snooze_duration = db.Column(db.Integer, default=10)
    repeat_missed = db.Column(db.Boolean, default=True)
    time_zone = db.Column(db.String(80), default="Asia/Kolkata")
    time_format = db.Column(db.String(20), default="12-hour")
    date_format = db.Column(db.String(20), default="DD/MM/YYYY")
    theme = db.Column(db.String(20), default="Light")
    language = db.Column(db.String(20), default="English")
    caregiver_name = db.Column(db.String(120), default="")
    caregiver_contact = db.Column(db.String(30), default="")
...
class CaregiverAccess(db.Model):
    ...
    label = db.Column(db.String(120), default="Caregiver")
    active = db.Column(db.Boolean, default=True, nullable=False)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
